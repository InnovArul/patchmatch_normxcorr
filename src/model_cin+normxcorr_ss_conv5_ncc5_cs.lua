...
function create_model()
    ...
    if(not opt.forceNewModel or lfs.attributes(LOAD_MODEL_NAME) ~= nil) then
        ...
        --Maxpool
        centralimg1_maxpool2 = nnpackage.SpatialMaxPooling(poolsize, poolsize, poolsize, poolsize, padsize, padsize)(centralimg1_relu2):annotate{
        ...
        --Maxpool
        centralimg2_maxpool2 = nnpackage.SpatialMaxPooling(poolsize, poolsize, poolsize, poolsize, padsize, padsize)(centralimg2_relu2):annotate{
        ...
        centralXcorrJoin = nn.JoinTable(1)({centralimg1_maxpool2, centralimg2_maxpool2}):annotate{
            name='Joining unit',
        ...
        centralglobal_summary = nn.SpatialConvolution(nstates[2], nstates[3], filtsize[3], filtsize[3], 1, 1,
        ...
        centralglobal_summary_maxpool = nn.SpatialMaxPooling(poolsize, poolsize, poolsize, poolsize, padsize, padsize)(centralglobal_summary):annotate{
            name='Normalized Cross Map correlation summary maxpooling unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_MAXPOOL}
        };
        
        --reshape
        centralreshapeXcorr = nn.Reshape(nstates[3]*4*4)(centralglobal_summary_maxpool):annotate{
            name='Reshaping unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_AUGMENTS}
        };
    ...
    -- Ahmed paper branch
       -- Joining layer to join the filtered features from two subNetworks
        centralCinJoin = nn.JoinTable(1)({centralimg1_maxpool2, centralimg2_maxpool2}):annotate{
            name='Joining unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_AUGMENTS}
        };
        ...
        centralacross_patch = nnpackage.SpatialConvolution(nstates[2], nstates[3], 3, 3, 1, 1,
        ...
        --Maxpool
        centralacross_maxpool = nnpackage.SpatialMaxPooling(poolsize, poolsize, poolsize, poolsize, padsize, padsize)(centralacross_patch):annotate{
        ...
        --reshape
        centralreshapeCin = nn.Reshape(nstates[3]*4*4)(centralacross_maxpool):annotate{
            name='Reshaping unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_AUGMENTS}
        };
        ...
        --Maxpool
        surroundimg1_maxpool2 = nnpackage.SpatialMaxPooling(poolsize, poolsize, poolsize, poolsize, padsize, padsize)(surroundimg1_relu2):annotate{
            name='Image[1] - Maxpooling(2)',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_MAXPOOL}
        };
        ...
        --Maxpool
        surroundimg2_maxpool2 = nnpackage.SpatialMaxPooling(poolsize, poolsize, poolsize, poolsize, padsize, padsize)(surroundimg2_relu2):annotate{
            name='Image[2] - Maxpooling unit(2)',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_MAXPOOL}
        };
        ...
        -- Joining layer to join the filtered features from two subNetworks
        surroundXcorrJoin = nn.JoinTable(1)({surroundimg1_maxpool2, surroundimg2_maxpool2}):annotate{
            name='Joining unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_AUGMENTS}
        };
        ...
        surroundglobal_summary = nn.SpatialConvolution(nstates[2], nstates[3], filtsize[3], filtsize[3], 1, 1,
												getPadSize(filtsize[3]), getPadSize(filtsize[3]))(surroundCCU_summary_relu):annotate{
            name='Normalized Cross Map correlation summary unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_MAXPOOL}
        };

        surroundglobal_summary_maxpool = nn.SpatialMaxPooling(poolsize, poolsize, poolsize, poolsize, padsize, padsize)(surroundglobal_summary):annotate{
            name='Normalized Cross Map correlation summary maxpooling unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_MAXPOOL}
        };
        
        --reshape
        surroundreshapeXcorr = nn.Reshape(nstates[3]*4*4)(surroundglobal_summary_maxpool):annotate{
            name='Reshaping unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_AUGMENTS}
        };
    ...
    -- Ahmed paper branch
       -- Joining layer to join the filtered features from two subNetworks
        surroundCinJoin = nn.JoinTable(1)({surroundimg1_maxpool2, surroundimg2_maxpool2}):annotate{
            name='Joining unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_AUGMENTS}
        };
        ...
        --Across patch features
        surroundacross_patch = nnpackage.SpatialConvolution(nstates[2], nstates[3], 3, 3, 1, 1,
        ...
        --Maxpool
        surroundacross_maxpool = nnpackage.SpatialMaxPooling(poolsize, poolsize, poolsize, poolsize, padsize, padsize)(surroundacross_patch):annotate{
            name='Across patch features[1] - Maxpooling unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_MAXPOOL}
        };
        ...
        --reshape
        surroundreshapeCin = nn.Reshape(nstates[3]*4*4)(surroundacross_maxpool):annotate{
            name='Reshaping unit',
            graphAttributes = {color = TEXTCOLOR, style = NODESTYLE, fillcolor = COLOR_AUGMENTS}
        };
        ...
        logger.trace(model.modules[12].weight:data()) -- img2 conv1
        logger.trace('centralimg1 conv2')
        logger.trace(model.modules[7].weight:data()) -- img1 conv2
        logger.trace('centralimg2 conv2')
        logger.trace(model.modules[15].weight:data()) -- img2 conv2
        
        logger.trace('surround patch branch')
        logger.trace('surroundimg1 conv1')
        logger.trace(model.modules[40].weight:data()) -- img1 conv1
        logger.trace('centralimg2 conv1')
        logger.trace(model.modules[47].weight:data()) -- img2 conv1
        logger.trace('centralimg1 conv2')
        logger.trace(model.modules[43].weight:data()) -- img1 conv2
        logger.trace('centralimg2 conv2')
        logger.trace(model.modules[50].weight:data()) -- img2 conv2        
